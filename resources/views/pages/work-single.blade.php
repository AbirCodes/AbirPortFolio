...
<!-- Mirrored from www.madebydesignesia.com/themes/nathan/work-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Feb 2026 09:49:33 GMT -->
<head>
                                    ...
                                    <div class="row g-4 wow fadeInUp" data-wow-delay=".7s">
                                        <div class="col-lg-6">
                                            <div class="hover relative overflow-hidden text-light">
                                              <a href="{{ asset('assets/images/work-single/1.webp') }}" class="image-popup overflow-hidden d-block relative">
                                                <img src="{{ asset('assets/images/work-single/1.webp') }}" class="img-fluid hover-scale-1-2" alt="">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="hover relative overflow-hidden text-light">
                                              <a href="{{ asset('assets/images/work-single/2.webp') }}" class="image-popup overflow-hidden d-block relative">
                                                <img src="{{ asset('assets/images/work-single/2.webp') }}" class="img-fluid hover-scale-1-2" alt="">
                                                <div class="absolute bottom-0 w-100 p-4 d-flex text-white justify-content-between">
                                                    <div class="d-tag-s2">Social Media Integration</div>
                                                    <div class="fw-bold text-uppercase">Uniqlo</div>
                                                </div>
...
<!-- Mirrored from www.madebydesignesia.com/themes/nathan/work-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Feb 2026 09:49:34 GMT -->
</html>
